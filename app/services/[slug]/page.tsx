...
export default function ServicePage({ params }: { params: { slug: string } }) {
    ...
    <main className="bg-gray-50">
      ...
      <section className="relative w-full h-[500px] md:h-[600px] flex items-center justify-center text-center">
        ...
        <div className="relative z-10 px-6 max-w-5xl mx-auto text-white">
          <h1 className="font-extrabold text-4xl md:text-6xl mb-4 drop-shadow-lg">
            {service.title}
          </h1>
          {service.subtitle && (
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
        <div>
          {service.heading && (
            <h2 className="font-bold text-3xl md:text-4xl mb-6 text-gray-900">
              {service.heading}
            </h2>
          )}
  ...
  <div className="max-w-6xl mx-auto px-6">
    <h2 className="font-bold text-3xl md:text-4xl mb-12 text-gray-900">
        ...
        return (
          <div
            ...
            className="flex flex-col items-center p-6 rounded-xl 
              ...
              shadow-sm hover:shadow-lg hover:scale-105 cursor-pointer"
          >
            {IconComponent && (
            ...
            <p className="font-semibold text-gray-800 text-sm sm:text-base text-center break-words">
              {industry.name}
            </p>
          </div>
        );
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid gap-10 md:grid-cols-3">
              {service.features.map((feat, idx) => (
                <div
                  key={idx}
                  className="border border-gray-200 bg-white p-6 rounded-lg shadow-sm hover:shadow-lg hover:border-blue-200 transition"
                >
      ...
      <section className="py-20 text-white text-center bg-gradient-to-r from-blue-500 to-blue-100">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <GetInTouchButton
            ...
            homePath="/"
            contactId="start-project"
            className="px-10 py-4 rounded-lg font-semibold bg-blue-500 hover:bg-blue-600 transition text-lg"
          />
        </div>
      </section>
    </main>
